...
namespace Tangonet_Pirani_Transaction_Consumer_Example
{
            ...
            foreach (var record in kinesisEvent.Records)
            {
                ...
                try
                {
                    ...
                    var transactionInfo = new TransactionInfo
                    {
                        ...
                        Nature = "1",
                        OperationValue = "100",
                        TransactionDate = DateTime.ParseExact(transactionDate, "yyyyMMddHHmmss", CultureInfo.InvariantCulture),

                        CheckValue = totalAmount.ToString(),
                        ElectronicChannelValue = "123",
                        CurrencyType = "default",
                    };

                    var json = System.Text.Json.JsonSerializer.Serialize(transactionInfo, new System.Text.Json.JsonSerializerOptions { IgnoreNullValues = true });
